...
public class SettingActivity extends AppCompatActivity {
    ...
    private AppCompatSpinner spinnerNav;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerNav = findViewById(R.id.setting_recordNav);
        ...
        spinnerNav.setSelection(sharedPreferences.getInt(Constants.KEY_NAV, Constants.DEF_RINEX_NAV), true);

        ((TextView) spinnerNav.getSelectedView()).setTextColor(getColor(R.color.colorOrange));
        spinnerNav.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ((TextView) spinnerNav.getSelectedView()).setTextColor(getColor(R.color.colorOrange));
                sharedPreferences.edit().putInt(Constants.KEY_NAV, position).apply();
            }
        ...
        spinnerVersion.setSelection(sharedPreferences.getInt(Constants.KEY_RINEX_VER, Constants.DEF_RINEX_VER), true);
        ((TextView) spinnerVersion.getSelectedView()).setTextColor(getColor(R.color.colorOrange));
        spinnerVersion.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ((TextView) spinnerVersion.getSelectedView()).setTextColor(getColor(R.color.colorOrange));
                sharedPreferences.edit().putInt(Constants.KEY_RINEX_VER, position).apply();
            }
