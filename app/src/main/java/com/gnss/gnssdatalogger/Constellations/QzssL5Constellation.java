...
public class QzssL5Constellation extends Constellation {
    private final static char satType = 'J';
    private static final String NAME = "QZSS L5";
    private static final String TAG = "QzssL5Constellation";
        ...
        synchronized (this) {
            ...
            for (GnssMeasurement measurement : event.getMeasurements()) {
                ...
                if (codeLock && (towDecoded || towKnown)  && pseudorange < 1e9) {
                    ...
                    satelliteParameters.setUniqueSatId("J" + satelliteParameters.getSatId() + "_L5");
