...
import com.gnss.gnssdatalogger.Constellations.Time;
...
public class ShapiroCorrection extends Correction {
    ...
    public void calculateCorrection(Time currentTime, Coordinates approximatedPose, SatellitePosition satelliteCoordinates) {
        ...
        correctionValue = ((2.0 * GNSSConstants.EARTH_GRAVITATIONAL_CONSTANT)/ Math.pow(GNSSConstants.SPEED_OF_LIGHT, 2)) * Math.log((geoDistSv + geoDistRx + geomDist ) / (geoDistSv + geoDistRx - geomDist));
