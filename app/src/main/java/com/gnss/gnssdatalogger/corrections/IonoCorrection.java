package com.gnss.gnssdatalogger.corrections;///*
...
//
//import com.gnss.ppptesttwo.GNSSConstants;
//import com.gnss.ppptesttwo.Time;
//import com.gnss.ppptesttwo.coord.Coordinates;
//import com.gnss.ppptesttwo.coord.SatellitePosition;
//
//
///**
...
//
//        IonoGps iono = navigationIono.getIonoGps();
//
//        if (iono.getBeta(0) == 0){
//
//            correctionValue = 0.0;
...
//            if (Math.abs(x) < 1.57) {
//                ionoCorr = GNSSConstants.SPEED_OF_LIGHT
//                        * f
//                        * (5e-9 + a
//                        * (1 - (Math.pow(x, 2)) / 2 + (Math.pow(x, 4)) / 24));
//            } else {
//                ionoCorr = GNSSConstants.SPEED_OF_LIGHT * f * 5e-9;
//            }
//
